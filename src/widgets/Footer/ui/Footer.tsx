...
const Footer: React.FC = () => {
  return (
    ...
    >
      <Container maxWidth="lg" sx={{ ml: 'auto', position: 'relative', zIndex: 1 }}>
        <Box
          sx={{
            display: 'flex',
        ...
        >
          ...
          >
            <Box sx={{ flexBasis: '33%!important' }}>
              ...
              <Typography variant="body1" sx={{ mb: 1.25, color: '#888888', width: 'max-content' }}>
                ИИ АССИСТЕНТЫ
              </Typography>
            ...
            >
              <Typography variant="subtitle1" sx={{ fontWeight: 'normal', mb: 1.25 }}>
                ПОДДЕРЖКА
              </Typography>
              <Link
                variant="body1"
                sx={{ mb: 1.25, color: '#888888' }}
                href="tg://resolve?domain=tps_supportbot"
                target="_blank"
                underline="none"
              >
            ...
            <Box sx={{ textAlign: { xs: 'start', md: 'end' } }} className={styles.footer__flex}>
              <Link
        ...
        >
          <Box className={styles.supFooter}>
            <Typography variant="body2">Все права защищены © 2025</Typography>
          </Box>
          <Typography variant="body2">Правовая информация</Typography>
        </Box>
        <Image src={LogoFooter} alt="logo" fill className={styles.logo__footer} />
      </Container>
    </Box>
  );
};
