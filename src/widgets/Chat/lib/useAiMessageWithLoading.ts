...
export const useAiMessageWithLoading = (
  ...
  const [lastGPTMessageHeight, setLastGPTMessageHeight] = useState(DEFAULT_AI_MESSAGE_HEIGHT);
  ...
  const onSendMessage = useCallback(() => {
    ...
    const GPTMessageHeight = blockHeight - userMessageHeight - AI_MESSAGE_LOADER_HEIGHT;
