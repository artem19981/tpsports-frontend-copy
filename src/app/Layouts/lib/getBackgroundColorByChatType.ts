...
export const getBackgroundColorByChatType = (type?: ChatType) => {
  if (type === ChatType.Trainer) {
    return {
      ...
      right:
        'radial-gradient(50% 50% at 50% 50%, rgba(216, 191, 8, 0.08) 0%, #121212 100%)',
    };
  }
  ...
  if (type === ChatType.Doctor) {
    return {
      ...
      right:
        'radial-gradient(50% 50% at 50% 50%, rgba(255, 255, 255, 0.06) 0%, #121212 100%)',
    };
  }
  ...
  if (type === ChatType.Nutritionolog) {
    return {
      ...
      right:
        'radial-gradient(50% 50% at 50% 50%, rgba(35, 64, 106, 0.1) 0%, #121212 100%)',
    };
  }
  ...
  if (type === ChatType.Psychologist) {
    return {
      ...
      right:
        'radial-gradient(50% 50% at 50% 50%, rgba(245, 75, 0, 0.1) 0%, #121212 100%)',
    };
  }
};
